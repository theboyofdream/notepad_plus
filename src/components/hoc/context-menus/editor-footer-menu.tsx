...
import { useContextMenu, useSettingStore } from "@/stores";
import { useState } from "react";

export function EditorFooterMenu() {
  // const elem = useRef<HTMLDivElement>(null);
  const { openedMenu, clickPosition, closeMenu } = useContextMenu();
  const isOpen = openedMenu === "editor-footer";
